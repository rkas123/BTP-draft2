...
class DepthEstimation extends StatefulWidget {
  static String routeName = '/DepthEstimation';
  final List<CameraDescription> _cameras;
  final String url;
  const DepthEstimation(this._cameras, this.url, {Key key}) : super(key: key);

  @override
  State<DepthEstimation> createState() => _DepthEstimationState();
}

class _DepthEstimationState extends State<DepthEstimation> {
  ...
  void hough() async {
    ...
    final url = Uri.parse("${widget.url}/raahi/depth_estimation");
